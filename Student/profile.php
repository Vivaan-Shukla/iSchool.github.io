...
if (isset($_REQUEST['updateStuNameBtn'])) {
    if (($_REQUEST['stuName'] == "")) {
        ...
        $img_folder = '../media/stu/' . $stu_image;
        move_uploaded_file($stu_image_temp, $img_folder);
        $sql = "UPDATE student SET stu_name = '$stuName', stu_occ =
        '$stuOcc', stu_mg = '$img_folder' WHERE stu_email =
        '$stuLogEmail'";
...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    <form class="mx-5" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="file" class="form-control-file" id="stuImg" name="stuImg" value=" <?php if (isset($stuImg)) {
                                                                                                echo $stuImg;
                                                                                            } ?>
           ">
        </div><br>
        <button type="submit" class="btn btn-outline-dark" name="updateStuNameBtn">Update</button>
